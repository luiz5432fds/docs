      ...
      body: ListView(
        ...
        children: [
          ...
          if (_consolidation != null) ...[
            ...
            Text('Acumulador no XPS-10: ${((_consolidation?['directAnswers'] as Map?)?['phaseAccumulatorOnXps10'] as Map?)?['explanation'] ?? '-'}'),
            Text('ADSR metais (nota): ${((_consolidation?['directAnswers'] as Map?)?['brassAdsr'] as Map?)?['note'] ?? '-'}'),
            Text('Hann granular: ${((_consolidation?['directAnswers'] as Map?)?['hanningWindow'] as Map?)?['explanation'] ?? '-'}'),
            const SizedBox(height: 8),
