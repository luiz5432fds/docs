...
int main()
{
    ...
    failures += failIf(mm8::PresetRules::shouldIgnoreFile(juce::File("C:/tmp/readme.html")), "should ignore html");
    ...
    failures += failIf(mm8::PresetRules::categoryForPath(juce::File("C:/Sounds/Organ/preset.nki")) != "Organ", "category organ");
    failures += failIf(mm8::PresetRules::categoryForPath(juce::File("C:/Sounds/Bass/preset.nki")) != "Bass", "category bass");
    failures += failIf(mm8::PresetRules::categoryForPath(juce::File("C:/Sounds/DrumKit/preset.nki")) != "Drums", "category drums");
